...
def test_is_melody_pitch_atom():
    ...
    assert is_melody_pitch_atom(FREQ_ONSET_OP, 14, -1)
    assert is_melody_pitch_atom(FREQ_NUDGE_OP, 0, FREQ_NUDGE_SUBREG_HI)
    assert is_melody_pitch_atom(FREQ_NUDGE_OP, 7, FREQ_NUDGE_SUBREG_LO)
    assert not is_melody_pitch_atom(FREQ_TRAJ_OP, 0, 6)
    assert not is_melody_pitch_atom(FREQ_TRAJ_OP, 2, FT_SUBREG_V0_HI)
    assert not is_melody_pitch_atom(FREQ_ONSET_OP, 2, -1)
