"""Collapse / bits measurement for the factored event stream (REDESIGN_optionB §9, §2.3): compression
comes from BPE over a complete escape-free encoding, not a dictionary+escape. This trains a corpus-global
greedy BPE over the factored token streams (the shared statistics ARE the dictionary, §8.6) and reports the
