"""Encoder: ordered register-write stream -> event stream (REDESIGN_optionB §8). Input is the fidelity
...
every refinement must keep the §9 ordered-stream roundtrip green.
"""
